...
package lyi.AIworkout.posemon.camera
...
import lyi.AIworkout.posemon.VisualizationUtils
import lyi.AIworkout.posemon.YuvToRgbConverter
...
import lyi.AIworkout.posemon.ml.PoseDetector
import java.util.*
...
class CameraSource(
    ...
    private fun processImage(bitmap: Bitmap) {
        ...
        if (persons.isNotEmpty()) {
            ...
            listener?.onDetectedInfo2(persons)
        }
    ...
    */
    ...
    interface CameraSourceListener {
        ...
        fun onDetectedInfo2(allData: MutableList<Person>?)
